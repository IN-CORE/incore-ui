		...
		<div>
			...
			<section className={classes.root}>
				<Container className={classes.container}>
					...
					{githubVersions && githubVersions["incore-docs"] ? (
						<Chip
							color="secondary"
							size="medium"
							className={classes.releaseChip}
							label={`IN-CORE ${githubVersions["incore-docs"]} IS RELEASED INCLUDING`}
						/>
					) : (
						<Chip
							color="secondary"
					...
					<div className={classes.versionSection}>
						{repos.map((repo) => (
							<div className={classes.versionLine} key={repo.title}>
				...
				<Container className={classes.sectionContainers}>
					<Grid container spacing={4}>
						{sections.map((section) => (
							<Grid item xs={12} md={3} key={section.titles[0]}>
				...
				<Container className={classes.footerContainer}>
					<Grid container spacing={5}>
						{footerLogos.map((footerLogo) => (
							<Grid item xs={6} sm={3} md={3} key={footerLogo.url}>
								<Grid
									container
									direction="column"
									justify="flex-end"
